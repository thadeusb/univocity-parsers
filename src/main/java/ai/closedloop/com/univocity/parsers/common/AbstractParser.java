...
import ai.closedloop.com.univocity.parsers.common.input.EOFException;
import ai.closedloop.com.univocity.parsers.common.iterators.RecordIterator;
import ai.closedloop.com.univocity.parsers.common.iterators.RowIterator;
import ai.closedloop.com.univocity.parsers.common.processor.RowProcessor;
import ai.closedloop.com.univocity.parsers.common.processor.core.NoopProcessor;
import ai.closedloop.com.univocity.parsers.common.processor.core.Processor;
import ai.closedloop.com.univocity.parsers.common.record.Record;
import ai.closedloop.com.univocity.parsers.common.record.RecordMetaData;
...
import ai.closedloop.com.univocity.parsers.common.input.*;
import ai.closedloop.com.univocity.parsers.common.iterators.*;
import ai.closedloop.com.univocity.parsers.common.processor.*;
import ai.closedloop.com.univocity.parsers.common.processor.core.*;
...
public abstract class AbstractParser<T extends CommonParserSettings<?>> {
	...
	public final void parse(Reader reader) {
		...
		try {
			...
			stopParsing();
		} catch (ai.closedloop.com.univocity.parsers.common.input.EOFException ex) {
			try {
				handleEOF();
			} finally {
				stopParsing();
