...
public class CsvFormat extends Format {
	...
	private char delimiterEscape = '\0';
	...
	public final void setDelimiterEscape(char delimiterEscape) {
		this.delimiterEscape = delimiterEscape;
	}

	public final char getDelimiterEscape() {
		return this.delimiterEscape;
	}
	...
	protected TreeMap<String, Object> getConfiguration() {
		...
		out.put("Delimiter escape", delimiterEscape);
		return out;
	}
